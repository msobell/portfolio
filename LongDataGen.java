...
public class LongDataGen {
	...
	try{
		...
		//  init low return to b/w 0.05 & .35
		rets[LO] = RND.nextDouble() * 0.30 + 0.05;
		//  init med return to b/w 0.05 & .55
		rets[MD] = RND.nextDouble() * 0.50 + 0.05;
		//  init hi return so avg is 1
		rets[HI] = ( 1 - ( probs[MD]*rets[MD] +
